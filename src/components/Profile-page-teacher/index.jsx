        ...
        <div className="Body-text-1">
          ...
          <div className="text-Message-1">
            ...
            <div className="second-2">
              Just wanted to tell you that i started your course and its going
              great!!
            </div>
          </div>
          <div className="Third-3">
            ...
            <div className="text-chat">
              <p className="Texxt-chat">
                Hello! Thank you for reaching out to me. Feel free to ask any
                questions regarding the course, I will try to reply ASAP
              </p>
            </div>
          </div>
